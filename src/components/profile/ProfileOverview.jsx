...
function ProfileOverview() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Profile Header */}
      <div style={{ background: "var(--secondary-gradient)" }} className=" p-6 text-white rounded-xl shadow flex items-center gap-4">
      ...
      <div  className="grid md:grid-cols-4 gap-4">
        ...
        <div style={{ background: "var(--secondary-gradient)" }} className=" p-4 rounded-xl shadow">
      ...
      {/* Progress Section */}
      <div style={{ background: "var(--secondary-gradient)" }} className=" p-5 rounded-xl shadow">
        <h3 className="font-semibold mb-3 text-gray-700">Progress</h3>

        <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
          <div style={{ background: "var(--info-gradient)" }}
